 ...
 * 
    {
        ...
        avatarURL: "https://randomuser.me/api/portraits/lego/7.jpg, // this is the url for the profile avatar
...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1> ${variables.name ? variables.name : "Here goes your name"}, ${
    variables.lastName ? variables.lastName : "and last name"
  } </h1>
